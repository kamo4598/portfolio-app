...
const links = [
  ...
  { name: "Linkedin", href: "https://www.linkedin.com/in/hassankamran98/", external: true },
  { name: "Github", href: "https://github.com/kamo4598/", external: true },
  { name: "Instagram", href: "https://www.instagram.com/kamohameha/", external: true },
];
const variants = {
  closed: {
    position: "fixed",
    ...
    >
      <motion.div className={cn("p-1.5 relative bg-gray-950 flex overflow-hidden flex-col")} variants={navVariants}>
        ...
        <div className="flex gap-7 sm:gap-16 w-full  items-center justify-between">
          <div className="size-9  grid place-content-center rounded-full text-gray-50">
